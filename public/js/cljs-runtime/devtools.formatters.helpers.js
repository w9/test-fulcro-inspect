...
var G__55767 = devtools.prefs.pref(v);
v = G__55767;
continue;
} else {
return v;
...
}catch (e55676){var _e__54695__auto__ = e55676;
return false;
}})();
...
}catch (e55678){var _e__54695__auto__ = e55678;
return false;
}})();
...
}catch (e55687){var _e__54695__auto__ = e55687;
return false;
}}
}
});
...
var vec__55705 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55705,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55705,(1),null);
...
return cljs.core.some((function (p1__55714_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__55714_SHARP_);
}),template);
});
