...
var G__75580 = clojure.zip.node(loc);
var fexpr__75579 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__75584 = clojure.zip.node(loc);
var fexpr__75583 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__75583.cljs$core$IFn$_invoke$arity$1 ? fexpr__75583.cljs$core$IFn$_invoke$arity$1(G__75584) : fexpr__75583.call(null,G__75584));
} else {
...
var fexpr__75586 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__75586.cljs$core$IFn$_invoke$arity$2 ? fexpr__75586.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__75586.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__75599 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75599,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75599,(1),null);
var vec__75602 = clojure.zip.children(loc);
var seq__75603 = cljs.core.seq(vec__75602);
var first__75604 = cljs.core.first(seq__75603);
var seq__75603__$1 = cljs.core.next(seq__75603);
var c = first__75604;
var cnext = seq__75603__$1;
var cs = vec__75602;
...
var vec__75608 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75608,(0),null);
var map__75611 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75608,(1),null);
var map__75611__$1 = cljs.core.__destructure_map(map__75611);
var path = map__75611__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75611__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75611__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75611__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75611__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75611__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__75620 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75620,(0),null);
var map__75623 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75620,(1),null);
var map__75623__$1 = cljs.core.__destructure_map(map__75623);
var path = map__75623__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75623__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__75624 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75623__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__75625 = cljs.core.seq(vec__75624);
var first__75626 = cljs.core.first(seq__75625);
var seq__75625__$1 = cljs.core.next(seq__75625);
var r = first__75626;
var rnext = seq__75625__$1;
var rs = vec__75624;
...
var vec__75632 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75632,(0),null);
var map__75635 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75632,(1),null);
var map__75635__$1 = cljs.core.__destructure_map(map__75635);
var path = map__75635__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75635__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75635__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__75640 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75640,(0),null);
var map__75643 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75640,(1),null);
var map__75643__$1 = cljs.core.__destructure_map(map__75643);
var path = map__75643__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75643__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75643__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__75651 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75651,(0),null);
var map__75654 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75651,(1),null);
var map__75654__$1 = cljs.core.__destructure_map(map__75654);
var path = map__75654__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75654__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75654__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__75659 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75659,(0),null);
var map__75662 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75659,(1),null);
var map__75662__$1 = cljs.core.__destructure_map(map__75662);
var path = map__75662__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75662__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__75684 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75684,(0),null);
var map__75687 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75684,(1),null);
var map__75687__$1 = cljs.core.__destructure_map(map__75687);
var path = map__75687__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75687__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__75694 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75694,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75694,(1),null);
...
var len__5769__auto___75897 = arguments.length;
var i__5770__auto___75898 = (0);
while(true){
if((i__5770__auto___75898 < len__5769__auto___75897)){
args__5775__auto__.push((arguments[i__5770__auto___75898]));

var G__75900 = (i__5770__auto___75898 + (1));
i__5770__auto___75898 = G__75900;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq75700){
var G__75701 = cljs.core.first(seq75700);
var seq75700__$1 = cljs.core.next(seq75700);
var G__75702 = cljs.core.first(seq75700__$1);
var seq75700__$2 = cljs.core.next(seq75700__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75701,G__75702,seq75700__$2);
}));
...
var G__75908 = clojure.zip.rightmost(child);
loc__$1 = G__75908;
continue;
} else {
return loc__$1;
...
var vec__75731 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75731,(0),null);
var map__75734 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75731,(1),null);
var map__75734__$1 = cljs.core.__destructure_map(map__75734);
var path = map__75734__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75734__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75734__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75734__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75734__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__75912 = clojure.zip.rightmost(child);
loc__$1 = G__75912;
continue;
} else {
return loc__$1;
