...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__38079){
var map__38082 = p__38079;
var map__38082__$1 = cljs.core.__destructure_map(map__38082);
var ast = map__38082__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38082__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38082__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__38087){
var map__38088 = p__38087;
var map__38088__$1 = cljs.core.__destructure_map(map__38088);
var child_ast = map__38088__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38088__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__38090 = idx;
var G__38090__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__38090,dispatch_key,parent_key):G__38090);
var G__38090__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__38090__$1,key,parent_key):G__38090__$1);
var G__38090__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__38090__$2,key,parent_key):G__38090__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__38090__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__38090__$3,child_ast));
} else {
return G__38090__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38106__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__38111){
var map__38113 = p__38111;
var map__38113__$1 = cljs.core.__destructure_map(map__38113);
var ast = map__38113__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38113__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38113__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,-689037934,null);

var map__38124 = app__$1;
var map__38124__$1 = cljs.core.__destructure_map(map__38124);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38124__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__38125 = cljs.core.deref(runtime_atom);
var map__38125__$1 = cljs.core.__destructure_map(map__38125);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38125__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__38148 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__38148__$1 = cljs.core.__destructure_map(map__38148);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38148__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__38179 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__38179__$1 = cljs.core.__destructure_map(map__38179);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38179__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__38195){
var map__38196 = p__38195;
var map__38196__$1 = cljs.core.__destructure_map(map__38196);
var app__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38196__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__38198_38239 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__38199_38240 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__38199_38240);
...
}),null)),null,425501608,null);
}
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__38198_38239);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__38201 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__38203 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__38203);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__38201);
}})], null);
}));
