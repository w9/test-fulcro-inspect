...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60440 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_60440(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60441 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_60441(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60442 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_60442(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60446 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_60446(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60447 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_60447(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60448 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_60448(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_60449 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_60449(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60451 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_60451(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60461 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_60461(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60465 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_60465(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60466 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_60466(b);
}
});
