...
var i_62485 = (0);
while(true){
if((i_62485 < arr.length)){
(arr[i_62485] = null);

var G__62486 = (i_62485 + (1));
i_62485 = G__62486;
continue;
} else {
}
...
var i_62498 = (self__.level + (1));
while(true){
if((i_62498 <= (new_level + (1)))){
(update[i_62498] = self__.header);

var G__62499 = (i_62498 + (1));
i_62498 = G__62499;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_62500 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_62500[i]));
} else {
x__$2.forward.push((((i < links_62500.length))?(links_62500[i]):null));
}

if((i < links_62500.length)){
(links_62500[i] = x__$2);
} else {
links_62500.push(x__$2);
}
...
var i_62507 = (0);
while(true){
if((i_62507 <= self__.level)){
var links_62508 = (update[i_62507]).forward;
if((x__$1 === (((i_62507 < links_62508.length))?(links_62508[i_62507]):null))){
(links_62508[i_62507] = (x__$1.forward[i_62507]));

var G__62509 = (i_62507 + (1));
i_62507 = G__62509;
continue;
} else {
var G__62510 = (i_62507 + (1));
i_62507 = G__62510;
continue;
}
} else {
...
var G__62526 = nx;
var G__62527 = (level__$1 - (1));
x = G__62526;
level__$1 = G__62527;
continue;
} else {
var G__62528 = x;
var G__62529 = (level__$1 - (1));
x = G__62528;
level__$1 = G__62529;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__62537 = nx;
var G__62538 = (level__$1 - (1));
x = G__62537;
level__$1 = G__62538;
continue;
} else {
var G__62539 = x;
var G__62540 = (level__$1 - (1));
x = G__62539;
level__$1 = G__62540;
continue;
}
