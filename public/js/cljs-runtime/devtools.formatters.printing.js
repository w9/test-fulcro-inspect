...
var len__5769__auto___55855 = arguments.length;
var i__5770__auto___55856 = (0);
while(true){
if((i__5770__auto___55856 < len__5769__auto___55855)){
args__5775__auto__.push((arguments[i__5770__auto___55856]));

var G__55857 = (i__5770__auto___55856 + (1));
i__5770__auto___55856 = G__55857;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55777){
var G__55778 = cljs.core.first(seq55777);
var seq55777__$1 = cljs.core.next(seq55777);
var G__55779 = cljs.core.first(seq55777__$1);
var seq55777__$2 = cljs.core.next(seq55777__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55778,G__55779,seq55777__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55799_SHARP_){
return (!((cljs.core.meta(p1__55799_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55813__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55814){var _e__54695__auto__ = e55814;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e55827){var _e__54695__auto__ = e55827;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__55836 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__55837 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__55837);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55839__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__55836);
}});
...
var temp__5802__auto___55892 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___55892)){
var managed_print_level_55893 = temp__5802__auto___55892;
var _STAR_print_level_STAR__orig_val__55843_55894 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__55844_55895 = managed_print_level_55893;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__55844_55895);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__55842_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__55842_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__55843_55894);
}} else {
job_fn();
}
