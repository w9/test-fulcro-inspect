...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_56519 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_56519(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_56523 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_56523(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56530 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_56530(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56534 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_56534(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56540 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_56540(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56546 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_56546(reader);
}
});
...
var G__56647 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__56648 = s.append(c);
c = G__56647;
s = G__56648;
continue;
}
