 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__34720){
var vec__34721 = p__34720;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34721,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34721,(1),null);
var ref = vec__34721;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__34734){
var vec__34735 = p__34734;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34735,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34735,(1),null);
var ref = vec__34735;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__34748){
var map__34749 = p__34748;
var map__34749__$1 = cljs.core.__destructure_map(map__34749);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34749__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__34753,entity,state_map,parent_node,idents_seen){
var map__34755 = p__34753;
var map__34755__$1 = cljs.core.__destructure_map(map__34755);
var join_node = map__34755__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34755__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34755__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__34781,entity,state_map,idents_seen){
var map__34782 = p__34781;
var map__34782__$1 = cljs.core.__destructure_map(map__34782);
var join_node = map__34782__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34782__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__34783){
var map__34787 = p__34783;
var map__34787__$1 = cljs.core.__destructure_map(map__34787);
var node = map__34787__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34787__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__34788 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34788,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__34795 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__34795) : union_key__GT_query.call(null,G__34795));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__34797,current_entity,state_map,idents_seen){
var map__34798 = p__34797;
var map__34798__$1 = cljs.core.__destructure_map(map__34798);
var top_node = map__34798__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34798__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34798__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__34799 = nil_nodes;
var G__34799__$1 = (((G__34799 == null))?null:cljs.core.first(G__34799));
if((G__34799__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__34799__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__34800 = result_node__$1;
var G__34800__$1 = (((G__34800 == null))?null:cljs.core.persistent_BANG_(G__34800));
if((G__34800__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__34800__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__34803 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__34803 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__34803,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__34804 = props;
var G__34804__$1 = (((G__34804 == null))?null:cljs.core.meta(G__34804));
if((G__34804__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__34804__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__34807 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__34808 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__34808);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__34807);
}});
/**
...
var map__34820 = cljs.core.meta(prior_props);
var map__34820__$1 = cljs.core.__destructure_map(map__34820);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34820__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34820__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
